    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-[#F8FAFC] px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 font-['Outfit']" data-testid="login-heading">
            Welcome Back
          </h1>
          <p className="text-sm text-slate-500 mt-1">Sign in to your CivicConnect account</p>
        </div>
